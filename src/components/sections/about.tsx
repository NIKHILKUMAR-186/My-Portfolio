        ...
        <div className="glass relative overflow-hidden rounded-3xl p-6">
          <div className="aspect-square w-full rounded-2xl bg-gradient-to-br from-primary/30 via-surface-2 to-accent/30 p-1">
            <div className="flex size-full items-center justify-center rounded-2xl bg-surface">
              <img src="/about.jpg" alt="Nikhil Kumar" className="w-full h-full object-cover  brightness-90 hover:grayscale-0 hover:brightness-100 transition-all duration-500 select-none scale-95 hover:scale-90 rounded-2xl" />
            </div>
          </div>
