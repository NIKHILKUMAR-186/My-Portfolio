...
import { u as useFloating, a as useHover, b as useDismiss, c as useRole, d as useInteractions, e as useTransitionStyles, F as FloatingPortal, f as FloatingArrow } from "./floating-ui__react.mjs";
import { g as getYear, p as parseISO, e as eachDayOfInterval, f as formatISO, i as isValid, a as getDay, s as subWeeks, n as nextDay, d as differenceInCalendarDays, b as getMonth } from "./date-fns.mjs";
import { a as autoUpdate } from "./floating-ui__dom.mjs";
import { f as flip, o as offset, s as shift, a as arrow } from "./floating-ui__react-dom.mjs";
...
function useColorScheme() {
  const [colorScheme, setColorScheme] = reactExports.useState(() => typeof window === "undefined" ? "light" : window.matchMedia(query$1).matches ? "dark" : "light");
...
function usePrefersReducedMotion() {
  const [prefersReducedMotion, setPrefersReducedMotion] = reactExports.useState(() => typeof window === "undefined" ? true : window.matchMedia(query).matches);
  reactExports.useEffect(() => {
...
function groupByWeeks(activities, weekStart = 0) {
  ...
  const firstCalendarDate = getDay(firstDate) === weekStart ? firstDate : subWeeks(nextDay(firstDate, weekStart));
...
const Tooltip$1 = /* @__PURE__ */ reactExports.lazy(() => Promise.resolve().then(function() {
  return TooltipB8gZJWmn;
}).then((module) => ({
  default: module.Tooltip
})));
const ActivityCalendar = /* @__PURE__ */ reactExports.forwardRef(({
  data: activities,
  blockMargin = 4,
  blockRadius = 2,
  blockSize = 12,
  ...
  function renderCalendar() {
    return weeks.map((week, weekIndex) => week.map((activity, dayIndex) => {
      ...
      const block = /* @__PURE__ */ jsxRuntimeExports.jsx("rect", {
        x: 0,
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Fragment, {
        children: tooltips.activity ? /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, {
    ...
    })).map((week, x) => /* @__PURE__ */ jsxRuntimeExports.jsx("g", {
  ...
  function renderFooter() {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", {
      ...
      children: [loading && /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        children: " "
      }), !loading && showTotalCount && /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
      ...
      }), !loading && showColorLegend && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: getClassName("legend-colors"),
        style: styles.footer.legend,
        children: [labels.legend.less && /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
          style: {
            marginRight: "0.4em"
          },
          children: labels.legend.less
        }), range(minLevel, maxLevel + 1).map((level) => {
          const colorLegend = /* @__PURE__ */ jsxRuntimeExports.jsx("svg", {
            width: blockSize,
            height: blockSize,
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Fragment, {
            children: tooltips.colorLegend ? /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, {
        ...
        }), labels.legend.more && /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
          style: {
            marginLeft: "0.4em"
          },
...
function Tooltip({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
    children: [/* @__PURE__ */ reactExports.cloneElement(children, {
      ...
      ...getReferenceProps()
    }), isMounted && /* @__PURE__ */ jsxRuntimeExports.jsx(FloatingPortal, {
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        ...
        ...getFloatingProps(),
        children: [text, withArrow && /* @__PURE__ */ jsxRuntimeExports.jsx(FloatingArrow, {
          ref: arrowRef,
          context,
...
const TooltipB8gZJWmn = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  Tooltip
});
export {
  ActivityCalendar as A
};
